  ...
  var startApp = function startApp() {
    ...
    var eLiquidApp = new Vue({
      ...
      filters: {
        ...
        'date-format': function dateFormat(date) {
          var d = moment(date);
          if (!d.isValid()) {
            return date;
          }
...
},{"./components/flavour-list":14,"./components/liquid-list":15,"./lib/ioconnection":16,"./lib/socket-connection":17,"./models/comment":18,"./models/flavour":19,"./models/liquid":20,"lodash":3,"moment":4}],14:[function(require,module,exports){
'use strict';
...
},{"../lib/ioconnection":16}],15:[function(require,module,exports){
'use strict';
...
},{"../lib/ioconnection":16}],16:[function(require,module,exports){
"use strict";
...
var SocketConnection = function () {
  ...
  _createClass(SocketConnection, null, [{
    key: 'createLiquid',
    value: function createLiquid(liquid) {
      return new Promise(function (resolve, reject) {
    ...
    key: 'updateLiquid',
    value: function updateLiquid(liquid) {
      return new Promise(function (resolve, reject) {
...
},{"./ioconnection":16,"promise":5}],18:[function(require,module,exports){
'use strict';
  ...
  _createClass(Comment, [{
    ...
    value: function save() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        } else if (!_this.liquid) {
          return reject(new Error("Comment must be connected to a liquid"));
        }

        SocketConnection.createComment(_this).then(resolve).catch(reject);
      });
    }
  }]);
...
},{"../lib/socket-connection":17,"promise":5}],19:[function(require,module,exports){
'use strict';
...
},{"../lib/socket-connection":17,"promise":5}],20:[function(require,module,exports){
'use strict';
...
var Liquid = function () {
  ...
  _createClass(Liquid, [{
    ...
    key: 'mlToPercent',
    value: function mlToPercent(ml) {
      return ml / this.getBatchSize();
    }
  }, {
    key: 'percentToMl',
    value: function percentToMl(percent) {
      return this.getBatchSize() * (percent / 100);
    }
  }, {
    key: 'getBaseNicStrength',
    value: function getBaseNicStrength() {
      return this.base.nicStrength;
    }
  }, {
    key: 'getTargetNicStrength',
    value: function getTargetNicStrength() {
      return this.target.nicStrength;
    }
  }, {
    key: 'getTargetPgPercent',
    value: function getTargetPgPercent() {
      return this.target.pgPercent;
    }
  }, {
    key: 'getTargetVgPercent',
    value: function getTargetVgPercent() {
...
},{"../lib/socket-connection":17,"promise":5}]},{},[13]);
