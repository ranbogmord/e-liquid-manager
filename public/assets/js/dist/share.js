...
var ShareLink = function () {
  ...
  _createClass(ShareLink, [{
    ...
    value: function save() {
      ...
      return new Promise(function (resolve, reject) {
        var url = '/share/create/' + _this.liquid;
        if (!!_this.expiry) {
          var date = moment(_this.expiry);
          if (date.isValid()) {
            url += '?expiry=' + date.toISOString();
          }
        }

        if (typeof _this.liquid !== "string") {
          _this.liquid = _this.liquid._id;
        }

        request({ method: 'get', url: url, json: true }, function (err, res) {
          if (err) return reject(err);

          var data = res.body;
          _this._id = data._id;
          _this.liquid = data.liquid;
          _this.expiry = data.expiry;
    ...
    value: function saveToUser() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        request({ method: 'POST', url: '/share/' + _this2._id + '/save' }, function (err, res) {
          if (err) return reject(err);
...
},{"browser-request":3,"moment":4,"promise":5}],14:[function(require,module,exports){
'use strict';

var ShareLink = require('./models/ShareLink');

},{"./models/ShareLink":13}]},{},[14]);
